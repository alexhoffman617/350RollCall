...
GraphicalView gv = ChartFactory.getBarChartView(context, dataset, multiRenderer, Type.DEFAULT);
...
//FOR STACKED
//can probably figure out a way to combine this with the one above
else{  
	// Creating an  XYSeries for Income
	XYSeries boys = new XYSeries("Boys");
	// Creating an  XYSeries for Expense
	...
	GraphicalView gv = ChartFactory.getBarChartView(context, dataset, multiRenderer, Type.STACKED);
